...
# questions per page
QUESTION_NUM = 100
# number of paper you need generate
PAPER_NUM = 5
# questions for go over, it's usally from notebook for incorrect answers in daily study
# PLEASE MAKE SURE qlib > 100 questions, or you can repeat your question to reach that number
qlib = ["16+5","48-5","53-8" ,"63+4" ,"56-4" ,"45-7" ,"61-5" ,"44-7" ,"37-2" ,"27+5",
		...
		"48-5","53-8" ,"63+4" ,"56-4" ,"45-7" ,"61-5" ,"44-7" ,"37-2" ,"27+5",
		"69-3","34-9","42-9" ,"18+32","27+18","68-54","97-72","29-14","49-26","30-16",
		"61-7","90-72","55-8","46+30+7","42-7-9","19+5+7","23+26+9","68-35-8","58-45-8","30-7",
		"43-8","50-48","72-49","33-21","36-18","52-27","71-2","72-6","89+7","47-9",
		"26+8","69+2","92-35","43-6",
...
def gen_html_question(questions,seq):
	...
	body_title = "<body><center><br><br><h2>二年级第一学期口算复习卷({})<br></h2>班级________&nbsp;&nbsp;&nbsp;姓名_______&nbsp;&nbsp;&nbsp;时间___________&nbsp;&nbsp;&nbsp;得分_________ <br><br>".format(seq+1)
